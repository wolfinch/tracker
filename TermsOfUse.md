...
No Guarantee: We do not guarantee the accuracy, completeness, or timeliness of the data. Vehicle availability and pricing change rapidly; users must verify all information directly with the listing dealer.

Predictive Analytics: Our "Inventory Movement" and "VIN Tracking" features are based on algorithmic inferences. A status of "Moved" or "Sold" is an estimate and does not represent an official record of sale or transport.

3. Intellectual Property (The "Fair Use" Clause)
Factual Data: We display factual information (VINs, year/make/model, mileage). In accordance with Feist Publications, Inc. v. Rural Telephone Service Co., these facts are not subject to copyright.

Creative Content: We do not host, store, or redistribute copyrighted photographs or original marketing descriptions belonging to Carvana or DriveTime. Where applicable, we provide outbound links to the original source.
...
Any technical inaccuracies resulting from changes to the source websites’ underlying API or data structure.

Direct, indirect, or incidental damages arising from the use of our tracking tools.
